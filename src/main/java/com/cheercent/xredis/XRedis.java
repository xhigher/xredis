...
public class XRedis {
	...
	private static final String SET_EX = "EX";
	...
	public static Boolean setnx(final RedisKey key, String value) {
		if (key != null) {
			...
			try {
				...
				return SET_OK.equals(jedis.set(key.name(), value, SET_NX, SET_EX, key.builder.expireTime));
			} catch (Exception e) {
	...
	public static class RedisKey {
		...
		public Boolean setFlag(){
			return XRedis.setnx(this, FLAG_VALUE);
		}
